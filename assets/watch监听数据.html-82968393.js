import{_ as n,X as s,Y as a,Z as p}from"./framework-cddc4983.js";const t={},e=p(`<h1 id="watch监听数据" tabindex="-1"><a class="header-anchor" href="#watch监听数据" aria-hidden="true">#</a> watch监听数据</h1><h2 id="vue2" tabindex="-1"><a class="header-anchor" href="#vue2" aria-hidden="true">#</a> vue2</h2><p>vue2中的watch监听数据的方式有两种：</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
