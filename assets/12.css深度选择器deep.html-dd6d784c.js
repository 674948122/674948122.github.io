...
&lt;/style&gt;
    ...
    <span class="token punctuation">}</span>
&lt;/style&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考</h2>`,10),p={href:"https://cn.vuejs.org/api/sfc-css-features.html#scoped-css",target:"_blank",rel:"noopener noreferrer"};function u(v,h){const s=l("ExternalLinkIcon");return a(),c("div",null,[r,e("ul",null,[e("li",null,[e("a",p,[t("文档链接"),d(s)])])])])}const b=n(o,[["render",u],["__file","12.css深度选择器deep.html.vue"]]);export{b as default};
