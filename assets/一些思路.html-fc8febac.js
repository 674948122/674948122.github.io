import{_ as r,E as a,Z as s,$ as c,a2 as n,a3 as e,a0 as p,a1 as o}from"./framework-4b017f08.js";const d={},i=o(`<h1 id="一些思路" tabindex="-1"><a class="header-anchor" href="#一些思路" aria-hidden="true">#</a> 一些思路</h1><p>----------------------------------------------------------1、微前端功能点答疑------------------------------------------------------------------</p><p>1、一般情况下不需要采用微前端模式的情况下，架构部推出的前端框架标准配置应该是什么样的</p><pre><code>a、qiankun的依赖、配置项（registerMicroApps、start等函数）、挂载点、读取子应用的配置或者请求保留是否存在问题
