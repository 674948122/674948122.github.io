import{_ as s,Z as a,$ as e,a1 as t}from"./framework-f650ad76.js";const p="/assets/images/16f41e75c1dc47a5.png",o={};function i(c,n){return a(),e("div",null,[...n[0]||(n[0]=[t(`<h1 id="微前端基座实施方案" tabindex="-1"><a class="header-anchor" href="#微前端基座实施方案" aria-hidden="true">#</a> 微前端基座实施方案</h1><h2 id="_1-安装qiankun依赖" tabindex="-1"><a class="header-anchor" href="#_1-安装qiankun依赖" aria-hidden="true">#</a> 1. 安装qiankun依赖</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>npm install qiankun
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,20)])])}const r=s(o,[["render",i],["__file","基座实施方案.html.vue"]]);export{r as default};
